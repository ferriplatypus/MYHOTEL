				...
				<form action="proses.php?aksi=tambah" method="post" enctype="multipart/form-data">
					<div class="row animate-box">
						<div class="col-md-6">
							...
							<p>Perusahaan kami bergerak di bidang perhotelan. kami melayani untuk pemesanan hotel di wilayah Jawa timur.</p>
							<ul class="contact-info">
								<li><i class="icon-location-pin"></i>Jl.jalan No.3</li>
								<li><i class="icon-phone2"></i>0344567499</li>
								<li><i class="icon-mail"></i><a href="#">myhotelbasyat@gmail.com</a></li>
								<li><i class="icon-globe2"></i><a href="#">www.myhotel.com</a></li>
							</ul>
						</div>
						<div class="col-md-6">
							<div class="row">
